...
from models import UnswNb15NeqModel, UnswNb15LutModel, UnswNb15NeqModel_add2
...
if __name__ == "__main__":
    ...
    model = UnswNb15NeqModel_add2(model_cfg)
    model.cuda()
   ...
   # Test the PyTorch model
    ...
    timecost_acc = end_time_acc - start_time_acc
    print("timecost_acc: ", timecost_acc)
    ...
    print("Top level entity stored at: %s/polylut_add.v ..." % (options_cfg["log_dir"]))

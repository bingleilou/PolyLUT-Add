...
from models import UnswNb15NeqModel,UnswNb15NeqModel_add2
...
def train(model, datasets, train_cfg, options):
    ...
    for epoch in range(0, num_epochs):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            pred = (torch.sigmoid(output.detach()) > 0.49) * 1
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--device", type=int, default=0, metavar="", help="Device_id for GPU"
    )

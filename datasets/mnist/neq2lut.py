...
from models import MnistNeqModel, MnistLutModel, MnistNeqModel_add2
other_options = {
    "seed": 3,
    "cuda": None,
    "device": 1,
...
if __name__ == "__main__":
    ...
    test_loader = DataLoader(
        dataset[args.dataset_split], batch_size=128, shuffle=False
    )
    ...
    model = MnistNeqModel_add2(model_cfg)
